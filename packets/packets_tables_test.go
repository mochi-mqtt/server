	...
	Connect: {
		...
		// wherever it appears in a string and MUST NOT be skipped over or stripped off by a packet receiver.
		{
			...
			packet: &Packet{
				...
				ProtocolVersion:  4,
				Keepalive:        20,
				ClientIdentifier: []byte{'e', 'b', 0xEF, 0xBB, 0xBF, 'd'},
			},
		},
	},
	Connack: {
